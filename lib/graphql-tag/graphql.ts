...
export type GetExpenseByIdQuery = { __typename?: 'Query', expenseById: { __typename?: 'ExpenseByIdPayload', code: number, success: boolean, message: string, expense?: { __typename?: 'Expense', id: number, code: number, description: string, budgetAccount: string, amount: number, createdAt: Date, updatedAt: Date } | null } };
