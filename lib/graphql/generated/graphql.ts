...
export type Query = {
  ...
  expenses: Array<BudgetTransaction>;
};
...
export type GetBudgetByCodeQuery = { __typename?: 'Query', budgetByCode: { __typename?: 'BudgetByCodePayload', code: number, success: boolean, message: string, budget?: { __typename?: 'Budget', code: string, name: string, amount: number, expense: number, balance: number, createdAt: string, updatedAt: string, transactions: Array<{ __typename?: 'BudgetTransaction', id: string, budgetCode: string, budgetName: string, description: string, amount: number, balance: number, transactionType: BudgetTransactionType, createdAt: string, updatedAt: string }> } | null } };
...
export type NewBudgetTransactionFragment = { __typename?: 'BudgetTransaction', id: string, budgetCode: string, budgetName: string, description: string, amount: number, balance: number, transactionType: BudgetTransactionType, createdAt: string, updatedAt: string } & { ' $fragmentName'?: 'NewBudgetTransactionFragment' };

export type GetExpensesQueryVariables = Exact<{ [key: string]: never; }>;


export type GetExpensesQuery = { __typename?: 'Query', expenses: Array<{ __typename?: 'BudgetTransaction', id: string, budgetCode: string, budgetName: string, description: string, amount: number, balance: number, transactionType: BudgetTransactionType, createdAt: string, updatedAt: string }> };
...
export type GetExpenseByIdQuery = { __typename?: 'Query', expenseById: { __typename?: 'ExpenseByIdPayload', code: number, success: boolean, message: string, expense?: { __typename?: 'BudgetTransaction', id: string, budgetCode: string, budgetName: string, description: string, amount: number, balance: number, transactionType: BudgetTransactionType, createdAt: string, updatedAt: string } | null } };
