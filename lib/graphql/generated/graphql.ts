...
export type GetBudgetByCodeQuery = { __typename?: 'Query', budgetByCode: { __typename?: 'BudgetByCodePayload', code: number, success: boolean, message: string, budget?: { __typename?: 'Budget', code: string, name: string, amount: number, expense: number, balance: number, createdAt: string, updatedAt: string, ledgerEntries: Array<{ __typename?: 'BudgetLedgerEntry', id: number, description: string, debit?: number | null, credit?: number | null, balance: number, createdAt: string }> } | null } };
...
export type CreateExpenseMutation = { __typename?: 'Mutation', createExpense: { __typename?: 'CreateExpensePayload', code: number, success: boolean, message: string, expense?: { __typename?: 'Expense', id: string, budgetCode: string, budgetName: string, amount: number, description: string, createdAt: string } | null } };
...
export type UpdateExpenseMutation = { __typename?: 'Mutation', updateExpense: { __typename?: 'UpdateExpensePayload', code: number, success: boolean, message: string, expense?: { __typename?: 'Expense', id: string, budgetCode: string, budgetName: string, amount: number, description: string, createdAt: string } | null } };

export type NewExpenseFragment = { __typename?: 'Expense', id: string, description: string, budgetCode: string, budgetName: string, amount: number, createdAt: string } & { ' $fragmentName'?: 'NewExpenseFragment' };

export type GetExpensesQueryVariables = Exact<{ [key: string]: never; }>;


export type GetExpensesQuery = { __typename?: 'Query', expenses: Array<{ __typename?: 'Expense', id: string, description: string, budgetCode: string, budgetName: string, amount: number, createdAt: string }> };
...
export type GetExpenseByIdQuery = { __typename?: 'Query', expenseById: { __typename?: 'ExpenseByCodePayload', code: number, success: boolean, message: string, expense?: { __typename?: 'Expense', id: string, description: string, budgetCode: string, budgetName: string, amount: number, createdAt: string } | null } };
