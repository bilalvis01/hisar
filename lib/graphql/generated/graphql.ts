...
export type Query = {
  ...
  expenseById: ExpenseByCodePayload;
...
export type GetBudgetQuery = { __typename?: 'Query', budgets: Array<{ __typename?: 'Budget', code: string, name: string, amount: number, expense: number, balance: number, createdAt: string, updatedAt: string }> };
...
export type GetBudgetByCodeQuery = { __typename?: 'Query', budgetByCode: { __typename?: 'BudgetByCodePayload', code: number, success: boolean, message: string, budget?: { __typename?: 'Budget', code: string, name: string, amount: number, expense: number, balance: number, createdAt: string, updatedAt: string, transactions: Array<{ __typename?: 'BudgetTransaction', id: string, description: string, expense?: number | null, balance: number, transactionType: BudgetTransactionType, createdAt: string, updatedAt: string }> } | null } };

export type NewBudgetFragment = { __typename?: 'Budget', code: string, name: string, amount: number, expense: number, balance: number, createdAt: string, updatedAt: string } & { ' $fragmentName'?: 'NewBudgetFragment' };
...
export type CreateBudgetMutation = { __typename?: 'Mutation', createBudget: { __typename?: 'CreateBudgetPayload', code: number, success: boolean, message: string, budget?: { __typename?: 'Budget', code: string, name: string, amount: number, expense: number, balance: number, createdAt: string, updatedAt: string } | null } };
...
export type DeleteBudgetMutation = { __typename?: 'Mutation', deleteBudget: { __typename?: 'DeleteBudgetPayload', code: number, success: boolean, message: string, budget?: { __typename?: 'Budget', code: string, name: string, amount: number, expense: number, balance: number, createdAt: string, updatedAt: string } | null } };
...
export type DeleteBudgetManyMutation = { __typename?: 'Mutation', deleteBudgetMany: { __typename?: 'DeleteBudgetManyPayload', code: number, success: boolean, message: string, budgets?: Array<{ __typename?: 'Budget', code: string, name: string, amount: number, expense: number, balance: number, createdAt: string, updatedAt: string }> | null } };
...
export type CreateExpenseMutation = { __typename?: 'Mutation', createExpense: { __typename?: 'CreateExpensePayload', code: number, success: boolean, message: string, expense?: { __typename?: 'Expense', id: string, budgetCode: string, budgetName: string, amount: number, description: string, createdAt: string, updatedAt: string } | null } };
...
export type UpdateExpenseMutation = { __typename?: 'Mutation', updateExpense: { __typename?: 'UpdateExpensePayload', code: number, success: boolean, message: string, expense?: { __typename?: 'Expense', id: string, budgetCode: string, budgetName: string, amount: number, description: string, createdAt: string, updatedAt: string } | null } };
...
export type DeleteExpenseMutation = { __typename?: 'Mutation', deleteExpense: { __typename?: 'DeleteExpensePayload', code: number, success: boolean, message: string, expense?: { __typename?: 'Expense', id: string, budgetCode: string, budgetName: string, amount: number, description: string, createdAt: string, updatedAt: string } | null } };
...
export type DeleteExpenseManyMutation = { __typename?: 'Mutation', deleteExpenseMany: { __typename?: 'DeleteExpenseManyPayload', code: number, success: boolean, message: string, expenses?: Array<{ __typename?: 'Expense', id: string, budgetCode: string, budgetName: string, amount: number, description: string, createdAt: string, updatedAt: string }> | null } };

export type NewExpenseFragment = { __typename?: 'Expense', id: string, description: string, budgetCode: string, budgetName: string, amount: number, createdAt: string, updatedAt: string } & { ' $fragmentName'?: 'NewExpenseFragment' };

export type GetExpensesQueryVariables = Exact<{ [key: string]: never; }>;


export type GetExpensesQuery = { __typename?: 'Query', expenses: Array<{ __typename?: 'Expense', id: string, description: string, budgetCode: string, budgetName: string, amount: number, createdAt: string, updatedAt: string }> };
...
export type GetExpenseByIdQuery = { __typename?: 'Query', expenseById: { __typename?: 'ExpenseByCodePayload', code: number, success: boolean, message: string, expense?: { __typename?: 'Expense', id: string, description: string, budgetCode: string, budgetName: string, amount: number, createdAt: string, updatedAt: string } | null } };
...
export const GetExpenseByIdDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetExpenseById"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"expenseById"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"code"}},{"kind":"Field","name":{"kind":"Name","value":"success"}},{"kind":"Field","name":{"kind":"Name","value":"message"}},{"kind":"Field","name":{"kind":"Name","value":"expense"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"budgetCode"}},{"kind":"Field","name":{"kind":"Name","value":"budgetName"}},{"kind":"Field","name":{"kind":"Name","value":"amount"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}}]}}]}}]}}]} as unknown as DocumentNode<GetExpenseByIdQuery, GetExpenseByIdQueryVariables>;